...
export interface EtheralShadowProps {
    ...
    staticFilter?: boolean; // Apply filter effects without animation
    noise?: NoiseConfig;
    style?: CSSProperties;
    className?: string;
...
export function EtheralShadow({
    ...
    const filterEnabled = animationEnabled || staticFilter;
        ...
        >
            <div
                style={{
                    ...
                    filter: filterEnabled ? `url(#${id}) blur(4px)` : "none"
                }}
            >
                {filterEnabled && (
                ...
                <div
                    style={{
                        ...
                        maskSize: sizing === "stretch" ? "300% 300%" : "300%",
